...
class ConsentSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $consents = [
            ...
            ['id' => 13, 'content' =>'Wyrażam zgodę na przetwarzanie moich danych osobowych przez WORK 4 YOU GLOBAL LTD z siedzibą w Wielkiej Brytanii, dla potrzeb niezbędne w celu realizacji umowy o świadczenie usług drogą elektroniczną i korzystanie z Serwisu www.dobrasztela.pl.','type'=>'Rejestracja opiekunki', 'required' => 1, 'created_at'=> date('Y-m-d H:i:s'), 'updated_at'=>date('Y-m-d H:i:s')],
            ['id' => 14, 'content' =>'Akceptuje <a href="/regulamin" class="orange-link">Regulamin</a> i <a href="/polityka-prywatnosci" class="orange-link">Politykę Prywatności</a>','type'=>'Rejestracja opiekunki', 'required' => 1, 'created_at'=> date('Y-m-d H:i:s'), 'updated_at'=>date('Y-m-d H:i:s')],
            ['id' => 15, 'content' =>'Wyrażam zgodę na przetwarzanie moich danych osobowych przez WORK 4 YOU GLOBAL LTD z siedzibą w Wielkiej Brytanii, dla potrzeb niezbędne w celu realizacji umowy o świadczenie usług drogą elektroniczną i korzystanie z Serwisu www.dobrasztela.pl.*','type'=>'Rejestracja pracodawcy', 'required' => 1, 'created_at'=> date('Y-m-d H:i:s'),'updated_at'=>date('Y-m-d H:i:s')],
            ['id' => 16, 'content' =>'Akceptuje <a href="/regulamin">Regulamin</a> i <a href="/polityka-prywatnosci">Politykę Prywatności*</a>','type'=>'Rejestracja pracodawcy', 'required' => 1, 'created_at'=> date('Y-m-d H:i:s'), 'updated_at'=>date('Y-m-d H:i:s')],
        ];
